    ...
    <div className="max-w-5xl mx-auto p-4 py-12">
      ...
      <div className="mb-12">
        ...
        <div className="relative">
          ...
          <div 
            className="absolute top-1/2 transform -translate-y-1/2 h-1 bg-purple-600 transition-all duration-300"
      ...
      <div className="flex justify-between">
        ...
        {currentStep < steps.length - 1 && (
          <button
            ...
            className="flex items-center px-4 py-2 font-medium text-white bg-purple-600 hover:bg-purple-700 rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Next
