              ...
              {customQueries.map((query, index) => (
                <div key={index} className="flex items-center">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white"
                  />
                  <button
                    type="button"
    ...
    <div
      ...
      className={`p-4 rounded-lg cursor-pointer transition-all duration-200 ${
        isSelected
          ...
          : 'bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 hover:border-purple-200 dark:hover:border-purple-800/50'
      }`}
    >
